...
namespace Inheritance19
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Total ship amount: {shipAmount.ToString("C")}\n\n");

            var total = CompleteTransaction(items);

            var grandTotal = total + taxAmount + shipAmount;

            Console.WriteLine("\n\nGRAND TOTAL ==> {0}", grandTotal.ToString("C"));//denotes currency
        ...
        static double CompleteTransaction(List<IPurchasable> items)
        {
            ...
            Console.WriteLine($"\n\nTotal amount of price is ==> ${totalAmount}");
            return totalAmount;
    ...
    public class Book : IPurchasable, ITaxable, IShippable
    {
        ...
        public double Ship()
        {
            Console.WriteLine($"    Shipping cost for book is ${ShippingRate}");
            return ShippingRate;
        }
    ...
    public class TShirt : IPurchasable, ITaxable, IShippable
    {
        ...
        public double Ship()
        {
            Console.WriteLine($"    Shipping cost for T-shirt is ${ShippingRate}");
            return ShippingRate;
        }
